    ...
    <div class="row">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <?php echo e(Form::open(['url'=>'manufacturer/save-manu', 'method'=>'POST', 'class'=>'form-horizontal'])); ?>
                      ...
                      <span class="text-danger"><?php echo e($errors->has('manufacturerName')? $errors->first('manufacturerName'): ''); ?></span>
                    </div>
								</div>
								<div class="form-group">
                      ...
                      <span class="text-danger"><?php echo e($errors->has('manufacturerDescription')? $errors->first('manufacturerDescription'): ''); ?></span>
								    </div>
								</div>
								<div class="form-group">
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\FirstProject\resources\views/admin/manufacturer/createManu.blade.php ENDPATH**/ ?>
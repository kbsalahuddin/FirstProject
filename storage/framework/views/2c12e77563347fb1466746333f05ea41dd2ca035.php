      ...
      <div class="row">
        ...
        <div class="col-md-6 well">
          ...
          <h3>Register Here!</h3><br />
            <?php echo e(Form::open(['route'=>'new-customer-sign-up','method'=>'post'])); ?>
        ...
        <div class="col-md-5 well" style="margin-left:20px">
          <h3>Login Here!</h3><br />
          <h3 class="text-center"><?php echo e(Session::get('message')); ?></h3><br />
          <?php echo e(Form::open(['route'=>'newuser-customer-login','method'=>'post'])); ?>
...
<?php echo $__env->make('front-end.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\FirstProject\resources\views/front-end/customer/customer-login.blade.php ENDPATH**/ ?>
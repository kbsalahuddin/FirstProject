							...
							<div clas="single-top">
								<div class="single-left">
									<div class="flexslider">
										<ul class="slides">
											<li data-thumb="{{ asset($product->productImage) }}">
												<div class="thumb-image"> <img src="{{ asset($product->productImage) }}" data-imagezoom="true" class="img-responsive"> </div>
											</li>
											<li data-thumb="{{ asset($product->productImage) }}">
												 <div class="thumb-image"> <img src="{{ asset($product->productImage) }}" data-imagezoom="true" class="img-responsive"> </div>
											</li>
								...
								<div class="single-right simpleCart_shelfItem">
									...
									<p class="price item_price"> .BDT {{$product->productPrice}}</p>
									<div class="description">
										<p><span>Quick Overview : </span>{{$product->productShortDescription}}</p>
									</div>

                  ...
                  <div class="product-tab">
                    ...
                    <div class="col-md-4 product-tab-grid simpleCart_shelfItem">
                      <div class="grid-arr">
                        <div  class="grid-arrival">
                          <figure>
                            <a href="#" class="new-gri" data-toggle="modal" data-target="#myModal1">
                              <div class="grid-img">
                                <img  src="{{ asset($categoryProduct->productImage) }}" class="img-responsive" alt="">
                              </div>
                              <div class="grid-img">
                                <img  src="{{ asset($categoryProduct->productImage) }}" class="img-responsive"  alt="">
                              </div>
                        ...
                        <div class="women">
                          <h6><a href="single.html"> {{ ($categoryProduct->productName) }}</a></h6>
                          <span class="size">XL / XXL / S </span>
                          <p ><del>$100.00</del><em class="item_price"> .BDT {{ ($categoryProduct->productPrice) }}</em></p>
											...
											<div class="product-tab1">
												...
												<div class="col-md-8 product-tab1-grid1 simpleCart_shelfItem">
													...
													<div class="women">
														<h6><a href="single.html">{{ ($categoryProduct->productName) }}</a></h6>
														<span class="size">XL / XXL / S </span>
														<p>{{ ($categoryProduct->productShortDescription) }}</p>
														<p>{{ ($categoryProduct->productLongDescription) }}</p>
														<p ><del>$100.00</del><em class="item_price">{{ ($categoryProduct->productPrice) }}</em></p>
														<a href="#" data-text="Add To Cart" class="my-cart-b item_add">Add To Cart</a>
													</div>
												</div>

				...
				<div class="arrivals-grids">
					...
					<div class="col-md-3 arrival-grid simpleCart_shelfItem">
						<div class="grid-arr">
							<div  class="grid-arrival">
								<figure>
									<a href="{{ route('product-details',['id'=>$newProduct->id]) }}" class="new-gri">
										<div class="grid-img">
											<img  src="{{ asset($newProduct->productImage) }}" class="img-responsive" alt="">
										</div>
										<div class="grid-img">
											<img  src="{{ asset($newProduct->productImage) }}" class="img-responsive"  alt="">
										</div>
							...
							<div class="women">
								<h6><a href="single.html">{{$newProduct->productName}}</a></h6>
								<span class="size">XL / XXL / S </span>
								<p ><del>$2000.00</del><em class="item_price"> .BDT {{$newProduct->productPrice}}</em></p>
